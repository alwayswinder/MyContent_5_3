...
#include "LinBlueprintLibBPLibraryEd.generated.h"
...
*/
UCLASS()
class ULinBlueprintLibBPLibraryEd : public UBlueprintFunctionLibrary
{
 ...
 // 	}
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Merge Component To Mesh"), Category = "LinBlueprintLibTesting")
	static bool MergeCompontentsToMesh(const AActor* ActorSelected, const FString &PackageName, int EachNum);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Coursor Pos In World"), Category = "LinBlueprintLibTesting")
	static FVector GetCoursorPosition();
};
