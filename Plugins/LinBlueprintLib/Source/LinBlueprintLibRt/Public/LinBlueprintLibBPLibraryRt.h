...
#include "LinBlueprintLibBPLibraryRt.generated.h"
...
UCLASS()
class ULinBlueprintLibBPLibraryRt : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintPure, Category = "CurveTool")
	static float GetRuntimeFloatCurveValue(const FRuntimeFloatCurve& CustomCurve, float inTime);
	...
	static bool GetSoftObjectRef_SkeleMesh(FString AssetPath, TSoftObjectPtr<USkeletalMesh>& OutSoftObjectRef);
	
	UFUNCTION(BlueprintCallable, Category = "Assets")
	static UObject* LoadAssetFromPath(FString AssetPath);
